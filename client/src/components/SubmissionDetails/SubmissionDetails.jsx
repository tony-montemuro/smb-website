...
function SubmissionDetails({ level, updateBoards }) {
  ...
  return (
    <div className={styles.submissionDetails}>
      ...
      <h2>
        <DetailedRecord submission={submission} iconSize="large" timerType={level.timer_type} />{" "}
        by&nbsp;
      ...
      {submission.tas && (
        <p>
          <b>Note:</b> This run is tool-assisted (TAS), and will not count toward any rankings.
        </p>
      )}
      ...
      <ul className={styles.details}>
        ...
        {submission.all_position ? (
          ...
          <li>
            <span className={styles.label}>Position:</span>&nbsp;{submission.position}
          </li>
        )}

        <li>
          <span className={styles.label}>Date:</span>&nbsp;{dateB2F(submission.submitted_at)}
        </li>
        <li>
          <span className={styles.label}>Monkey:</span>&nbsp;{submission.monkey.monkey_name}
        </li>
        <li>
          <span className={styles.label}>Platform:</span>&nbsp;{submission.platform.platform_name}
        </li>
        <li>
          <span className={styles.label}>Region:</span>&nbsp;{submission.region.region_name}
        </li>
        <li>
          <span className={styles.label}>Live:</span>&nbsp;
          <div className={styles.svgWrapper}>
            {submission.live ? (
              <CheckIcon titleAccess="This submission has a live proof." />
            ) : (
              <CloseRoundedIcon titleAccess="This submission has no live proof." />
            )}
          </div>
        </li>
        {submission.comment && (
          <li>
            <span className={styles.label}>Comment:</span>&nbsp;&quot;{submission.comment}&quot;
          </li>
        )}
        {submission.mod_note && (
          <li>
            <span className={styles.label}>Moderator Note:</span>&nbsp;&quot;{submission.mod_note}
            &quot;
          </li>
        )}
      </ul>
