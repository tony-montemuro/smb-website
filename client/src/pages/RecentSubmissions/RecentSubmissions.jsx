...
function RecentSubmissions({ imageReducer }) {
  ...
  const { updateGames, updateUsers, updateCategories, filtersData, fetchGames, fetchUsers } =
    ...
    <div className={styles.recentSubmissions}>
      ...
      <div className={styles.header}>
        ...
        <div className={styles.btns}>
          <button type="button" onClick={() => setGamePopup(true)}>
            Filter by Game
          </button>
          <button type="button" onClick={() => setUserPopup(true)}>
            Filter by User
          </button>
          <button type="button" onClick={() => setOtherPopup(true)}>
            Other Filters
          </button>
        </div>
      </div>
