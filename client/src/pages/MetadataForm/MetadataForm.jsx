    ...
    <Container title="Main Information">
      ...
      >
        <div className={styles.popupHeader}>
          ...
          <em>
            In the event a custom game has a creator with no SMBElite account, create a new account
      ...
      <form onSubmit={validateAndUpdate} className={styles.metadataForm}>
        <span>
          <em>On this screen, you will fill out information directly related to the game.</em>
        </span>
        <TextField
          id="name"
        ...
        <DatePicker
          ...
          slotProps={{
            ...
            textField: {
              error: form.error.release_date ? true : false,
          ...
          <>
            <DatePicker
              ...
              slotProps={{
                field: { clearable: false },
                textField: {
                  error: form.error.min_date ? true : false,
