...
function Auth() {
  /* ===== STATES & FUNCTIONS ===== */
  const { form, error, handleChange, getButtonText, setMode, handleSubmit } = AuthLogic();
  ...
  return (
    <form id={styles.form} className={styles.container} onSubmit={handleSubmit} autoComplete="on">
      ...
      <div className={styles.container}>
        ...
        <Password form={form} handleChange={handleChange} mode={form.mode} error={error} />
      </div>

      {/* Submit button, optional error message, & links, which modify form.mode */}
      <button id={styles.button} type="submit" disabled={form.loading}>
        {getButtonText()}
      </button>
