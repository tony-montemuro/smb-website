  ...
  return (
    <Container title="Game Assets">
      <div className={styles.form}>
        ...
        <span>
          Currently, the only game-specific asset is <strong>box art</strong>. In the future, this
        ...
        <form
          ...
          onSubmit={(e) => handleBoxArtSubmit(e, boxArtRef)}
        >
          <h3>Box Art</h3>
          <span>
            ...
            <strong>
              {assetsData.boxArt.dimensions.MAX_WIDTH} × {assetsData.boxArt.dimensions.MAX_HEIGHT}{" "}
              pixels
            </strong>
