  ...
  return (
    <div className={styles.popup}>
      ...
      <h2>
        ...
        &nbsp;has reported {user.id === submission.profile.id ? "your" : "the following"}{" "}
        submission:
      </h2>
      ...
      <div className={styles.details}>
        <ul>
          ...
          <li>
            <NotificationProof proof={submission.proof} isLive={submission.live} />
          </li>
          <li>
      ...
      <p>
        <b>Note: </b>
        <i>
          It is suggested that you ensure all properties of your submission are valid. If you are
          confident your submission is fine, do not worry. If not, a moderator may be forced to
          delete your submission!
        </i>
      </p>
      <p>
        <i>
          If a moderator falsely deletes any of your submissions, please contact the moderation
          team.
        </i>
      </p>
    </div>
