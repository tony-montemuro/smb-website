    ...
    <div className={styles.popup}>
      ...
      <div className={styles.details}>
        <ul>
          ...
          <li>
            <span className={styles.wrapper}>Category: {categoryName}</span>
          </li>
          ...
          <li>
            <span className={styles.wrapper}>
              ...
              <Link to={chartUrl}>
                <div>
                  <FancyLevel level={notification.level.name} />
                  &nbsp;({capitalize(notification.score ? "score" : "time")})
                </div>
              </Link>
            </span>
          </li>
          ...
          {notification.platform.id !== submission.platform.id ? (
            <li>
              <div className={styles.updated}>
                <span className={styles.wrapper}>
                  Platform: {notification.platform.platform_name} →{" "}
                  {submission.platform.platform_name}
                </span>
              </div>
            </li>
          ) : (
          ...
          {notification.live !== submission.live ? (
            <li>
              <div className={styles.updated}>
                <span className={styles.wrapper}>
                  Live Proof: <CheckmarkOrX isChecked={notification.live} /> →{" "}
                  <CheckmarkOrX isChecked={submission.live} />
                </span>
              </div>
            </li>
          ) : (
            <li>
              <span className={styles.wrapper}>
                Live Status: <CheckmarkOrX isChecked={submission.live} />
              </span>
            </li>
          )}
            ...
            <li>
              <div className={styles.updated}>
                <span className={styles.wrapper}>
                  ...
                  <CheckmarkOrX isChecked={submission.tas} />
                </span>
              </div>
            </li>
          ) : (
          ...
          {notification.mod_note !== submission.mod_note ? (
            ...
            <li>
              <span className={styles.wrapper}>
                Moderator Note:&nbsp;{notification.mod_note ? `"${notification.mod_note}"` : `""`}
              </span>
            </li>
          )}
        </ul>
