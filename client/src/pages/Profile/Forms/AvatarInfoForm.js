...
const AvatarInfoForm = (MAX_IMG_LENGTH) => {
  ...
  const submitAvatar = async (e, avatarRef, imageReducer) => {
    ...
    try {
      ...
      addMessage(
        "Avatar successfully uploaded. If it is not showing up, give it some time and reload the page.",
        "success",
        9000,
      );
    } catch (error) {
      addMessage(
        "There was a problem uploading your avatar. Refresh the page and try again.",
        "error",
        10000,
      );
    } finally {
