...
const UserInfoForm = () => {
    ...
    const uploadUserInfo = async (e) => {
        ...
        try {
            ...
            addToastMessage("Profile information has successfully updated!", "success", 5000);

        } catch (error) {
            // special case: user attempted to update their username to a non-unique name
            if (error.code === "23505") {
                addToastMessage("This username is already taken.", "error", 5000);
            ...
            // general case: render an error message, and reset the uploading flag
                ...
                addToastMessage("There was an error updating your profile. Try refreshing the page.", "error", 10000);
            }
