  ...
  const arrayBasedFilters = [
    {
      ...
      propertyName: "live",
      items: [
        { id: true, name: "Live Proofs" },
        { id: false, name: "Replay Proofs" },
      ],
    },
    {
      name: "Monkey",
    ...
    },
    {
      ...
      propertyName: "tas",
      items: [
        { id: false, name: "Normal runs" },
        { id: true, name: "TAS runs" },
      ],
    },
  ];
    ...
    filters && (
      <>
          ...
          from default value */}
            <div className={styles.header}>
              ...
              {hasFilterChanged("obsolete") && (
                <button type="button" onClick={() => handleFilterReset("obsolete")}>
                  Reset
                </button>
              )}
            </div>
          ...
          from default value */}
            <div className={styles.header}>
              ...
              {hasFilterChanged("endDate") && (
                <button type="button" onClick={() => handleFilterReset("endDate")}>
                  Reset
                </button>
              )}
            </div>
        ...
        <div className={styles.footer}>
          <button type="button" className="cancel" onClick={handleFiltersResetAll}>
            Reset filters
          </button>
          <button type="button" onClick={() => handleApplyFilters(updateBoard)}>
            Apply filters
          </button>
        </div>
      </>
