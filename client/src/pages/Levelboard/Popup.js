    ...
    trigger ? 
      ...
      <div className="popup">
        <div className="popup-inner">
          ...
          <button onClick={ () => removeFunc(playerInfo.user_id, null) }>Yes</button>
      ...
      <div className="popup">
        <div className="popup-inner">
            ...
            <button onClick={ () => removeFunc(playerInfo.user_id, mode === "Score" ? playerInfo.Score : playerInfo.Time) }>Yes</button>
            <button onClick={ () => setTrigger(false) }>No</button>
        </div>
      </div> 
    :
