...
const StructureForm = (chartDefaults, setChartDefaults) => {
    ...
    const handleLevelChange = e => {
        ...
        if (field.startsWith("ascending")) {
            ...
            field = fieldVals[0];
            value = getAscendingValue(fieldVals[1], checked, level.ascending);
        }
    ...
    // FUNCTION 29: handleChartDefaultsChange - function that is called when user makes changes to the chart defaults form
    // PRECONDITIONS (1 parameter):
